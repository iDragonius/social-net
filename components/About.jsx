    ...
    const change = ()=>{
        if(configure){
            ...
            if(answer){
                ...
                setNickanme(store.userInfo.nickname)
        ...
        <div className = 'mt-28 ml-4 flex flex-col transition-all duration-300 pb-40'>
            ...
            <div className='flex flex-col mx-auto justify-center mt-10 rounded-xl shadow-lg w-full pb-10 pt-7 bg-white '>
                    ...
                    {configure? '' :<button 
                                        ...
                                        className = 'transition-all duration-300 font-bold text-xl py-4 px-10 mx-auto mt-6 bg-indigo-600 text-white rounded w-min'>
                                            Save
                                    </button>}
                </div>
                <div className='flex flex-col mx-auto justify-center mt-10 rounded-xl shadow-lg w-full pb-10 pt-7 bg-white '>
